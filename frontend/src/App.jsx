...
function App() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    //In the submit handler, this is where we are going to talk to our api

    //And our server or backend is going to talk to the exchange rate api for the main logic
    ...
    try {
      ...
      //for the post method in the axios we have to pass in the payload
      //The payload represents what the user is passing to the server
